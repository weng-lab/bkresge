...
# log_file <- "/zata/zippy/kresgeb/hippocampus/my_output/nmf/2024_dlpfc/cross_validate.log"
log_file <- "/zata/zippy/kresgeb/hippocampus/my_output/nmf/2024_dlpfc/cross_validate_fine_k.log"
...
path_to_data <- "/data/zusers/kresgeb/psych_encode/spatialDLPFC_snRNAseq_fetch/2024_snRNA.RData"
# path_for_cvnmf <- "/zata/zippy/kresgeb/hippocampus/my_output/nmf/2024_dlpfc/cvnmf.rda"
path_for_cvnmf <- "/zata/zippy/kresgeb/hippocampus/my_output/nmf/2024_dlpfc/cvnmf_fine_k.rda"
...
p1 <- plot(cvnmf)
ggsave(
    # filename = "/zata/zippy/kresgeb/hippocampus/my_output/nmf/2024_dlpfc/cross_validate_plot1.png",
    filename = "/zata/zippy/kresgeb/hippocampus/my_output/nmf/2024_dlpfc/cross_validate_fine_k_plot1.png",
    plot = p1,
    width = 8,
    height = 6,
    dpi = 300
...
ggsave(
    # filename = "/zata/zippy/kresgeb/hippocampus/my_output/nmf/2024_dlpfc/cross_validate_plot2.png",
    filename = "/zata/zippy/kresgeb/hippocampus/my_output/nmf/2024_dlpfc/cross_validate_fine_k_plot2.png",
    plot = p2,
    width = 8,
    height = 6,
    dpi = 300
